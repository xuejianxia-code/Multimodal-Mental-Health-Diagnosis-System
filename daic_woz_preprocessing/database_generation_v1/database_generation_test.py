...
if __name__ == '__main__':
    ...
    # output root
    root = 'D:\\博士资料\\all class_3semester\\AI_project_class\\DepressionEstimation-main\\output_test'
    ...
    gt_path = 'D:\博士资料\\all class_3semester\AI_project_class\DepressionEstimation-main\daic_woz_preprocessing\Excel for splitting data\\corrected_full_test_split.csv'

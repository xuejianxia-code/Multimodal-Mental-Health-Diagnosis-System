...
if __name__ == '__main__':
    ...
    # output root
    root = 'D:\\博士资料\\all class_3semester\\AI_project_class\\DepressionEstimation-main\\output_train_daic'
    root_dir = os.path.join(root, 'DAIC_WOZ-generated_database', 'train')
    create_folders(root_dir)
    np.random.seed(1)

    # read  gt file
    # gt_path = 'D:\\博士资料\\all class_3semester\\AI_project_class\\DAIC-WoZ-Summarization-main\\data\\datasets\\labels\\train_data.csv'
    gt_path='D:\博士资料\\all class_3semester\AI_project_class\DepressionEstimation-main\daic_woz_preprocessing\Excel for splitting data\\corrected_full_train_split_Depression_AVEC2017.csv'
    ...
    for i in range(len(gt_df)):
        ...
        # phq_subscores_gt = gt_df.iloc[i, 6:].to_numpy().tolist()
        ...
        # keypoints_path = f'D:\\博士资料\\all class_3semester\\AI_project_class\\DAIC-WoZ-Summarization-main\\data\\datasets/{patient_ID}_P/{patient_ID}_CLNF_features3D.txt'

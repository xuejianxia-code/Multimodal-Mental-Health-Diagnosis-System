...
def main(dataloaders, text_net, evaluator, base_logger, writer, config,config_out_dir, args, model_type, ckpt_path):
...
if __name__ == '__main__':
    ...
    main(dataloaders, text_net, evaluator, base_logger, writer, config['MODEL'],config['OUTPUT_DIR'] ,args, model_type, ckpt_path)
